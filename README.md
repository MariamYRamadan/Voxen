# PulseAI — AI-Powered Product Feedback Analyzer
...
![PulseAI](https://img.shields.io/badge/Built%20with-Claude%20API-00e5ff?style=flat-square) ![Agile](https://img.shields.io/badge/Methodology-Agile%2FScrum-a78bfa?style=flat-square) ![Responsible AI](https://img.shields.io/badge/Responsible%20AI-Audited-fbbf24?style=flat-square)
...
**PulseAI solves this by using a large language model to:**
...
| **Sample Datasets** | SaaS, Mobile, E-commerce demo data | User-centered thinking |
...
User pastes feedback
        ↓
Claude API (claude-sonnet) classifies sentiment,
...
- Anthropic Claude API (`claude-sonnet-4-20250514`) via REST
...
PulseAI was built with responsible AI principles embedded in the product — not bolted on as an afterthought.
...
**Data minimization:** No feedback data is stored, logged, or transmitted beyond the Claude API call. The API key lives in-session memory only and is never persisted.
...
2. Open `feedback-analyzer.html` in your browser — no build step needed.

3. Get a free API key at console.anthropic.com

4. Paste your API key, add feedback, click Analyze.

---

## Product Learnings

Building PulseAI reinforced three core PM skills:
